...
$smt->execute(array($_GET['cid']));
	...
	// Check if a book is found with the provided book ID
	if ($book) {
		// Display the details of the specific book
		echo '<article class="product">
			...
			<section class="details">
				...
				<p>Auction created by <a href="#">authorName</a></p>
				<p class="price">Buy Now: £' . $book['price'] . '</p>
			...
			<section class="reviews">
				...
				<ul>
					<li><strong>Ali said </strong> great buyer! Product as advertised and delivery was quick <em>29/09/2019</em></li>
		...
		echo "No record found for the provided book ID.";
	}
} else {
